...
export class AgentRuntime {
  ...
  constructor(opts) {
    ...
    this.agentId =
      opts.character?.id ?? opts?.agentId ?? stringToUuid(opts.character?.name ?? generateUUID());
  ...
  async composeState(
    message,
    filterList = null, // only get providers that are in the filterList
    includeList = null // include providers that are private, dynamic or otherwise not included by default
  ) {
