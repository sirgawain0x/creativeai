 ...
 */
export declare function findEntityByName(
 ...
 */
export declare function getEntityDetails({
  runtime,
  roomId,
}: {
  runtime: IAgentRuntime;
 ...
 */
export declare function formatEntities({ entities }: { entities: Entity[] }): string;
