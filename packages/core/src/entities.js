 ...
 */
export async function findEntityByName(runtime, message, state) {
  try {
    ...
    const allEntities = [...filteredEntities, ...relationshipEntities.filter((e) => e !== null)];
 ...
 */
export const createUniqueUuid = (runtime, baseUserId) => {
